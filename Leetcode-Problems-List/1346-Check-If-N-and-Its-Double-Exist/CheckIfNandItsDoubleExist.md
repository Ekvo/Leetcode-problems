## 1346. Check If N and Its Double Exist => [original page](https://leetcode.com/problems/check-if-n-and-its-double-exist/description/ "https://leetcode.com/problems/check-if-n-and-its-double-exist/description/")
